...
tool_bar = QLabel(GUI)
if darkmode == True:
    tool_bar.setPixmap(QPixmap('.\\pictures\\toolbar_dark\\tool_bar_back_dark.png'))
else:
    tool_bar.setPixmap(QPixmap('.\\pictures\\toolbar_light\\tool_bar_back_light.png'))
tool_bar.setGeometry(-10,height - 130,700,100)
tool_bar.setScaledContents(True)

#关闭按钮
close_button = QPushButton(GUI)
close_button.setGeometry(600,height - 117,70,70)
...
ocr_button.setGeometry(500,height - 117,70,70)
if darkmode == True:
...
copy_button.setGeometry(400,height - 117,70,70)
if darkmode == True:
